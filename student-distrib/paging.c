...
void initialize_page() {
	...
	/* video memory is at 0xB8000, in other words in index 0 of the directory_entry_array, and in index 23 of the table_entry_array */
	...
	/* kernel space is from 4MB-8MB, in other words in index 1 of the directory_entry_array */
	...
	directory_entry_array[1].p_table_addr = KERNEL_ADDR>>3;	// address has to be mapped from 4 kB
